...
% % 
% % %% 
% repolarize = WaveEnd_3D(calcium, cuttime, numtrial, photobleaching, [savename '/AllImages'], fileloc, name, Locations, timestore,start_indx_repol, end_indx_repol, time,1, 0);
% 
% % 
% % %% 
...
%save([savename, savetime, 'tenperc_all' 'Analysis', '.mat'], 'network_all','wave_all', 'depolarize_all','repolarize_all', 'time_all', 'calcium_all')
